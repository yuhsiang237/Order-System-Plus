      ...
      <div class="search-area">
        <div class="container">
          <div class="row">
            <div class="col">
              <div>
                <h1 class="pt-5 pb-3 main-color01">出貨單管理</h1>
              </div>
              <div class="row">
              ...
              <table class="table table-hover">
                ...
                <tbody v-if="isLoading == false">
                  <tr v-for="(item, index) in listData">
                    ...
                    <td>
                      {{ DateTool.toDateString(item.deliveryDate) }}
                    </td>
                    <td>{{ DateTool.toDateString(item.finishDate) }}</td>
                    <td>
                      <router-link
  ...
  setup() {
    ...
    const fetchData = async () => {
      ...
      var res = await HttpClient.post(
        import.meta.env.VITE_APP_AXIOS_SHIPMENTORDERMANAGE_GETSHIPMENTORDERLIST,
        {
          orderNumber: searchfilter.value?.orderNumber,
